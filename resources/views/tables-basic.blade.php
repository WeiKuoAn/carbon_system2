            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc"> Add <code>.table-sm</code> to make tables more compact
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">A <code>&lt;caption&gt;</code> functions like a heading for a table.
