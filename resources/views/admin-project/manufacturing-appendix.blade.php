                                                        ...
                                                        <div class="form-check font-size-16">
                                                            ...
                                                            <label class="form-check-label" for="m_two_appendix01">
                                                                <h5 class="font-size-16 m-0">
                                                                    ...
                                                                    <a href="{{ URL::asset('storage/downloads/製造業_個人資料提供同意書.pdf') }}" download="製造業_個人資料提供同意書.pdf">
                                                                        （請點擊我下載空白文件）
                                                                    </a>
                                                                </h5>
                                                            </label>
                                                        ...
                                                        <div class="form-check font-size-16">
                                                            ...
                                                            <label class="form-check-label" for="m_two_appendix02">
                                                                <h5 class="font-size-16 m-0">2.建議迴避之人員清單（若無者請於表格中姓名欄中填【無】，另下方處需加蓋公司大小章。）
                                                                     <a href="{{ URL::asset('storage/downloads/製造業_建議迴避之人員清單.pdf') }}" download="製造業_建議迴避之人員清單.pdf">
                                                                    （請點擊我下載空白文件）
                                                                     </a>
                                                                </h5>
                                                            </label>
