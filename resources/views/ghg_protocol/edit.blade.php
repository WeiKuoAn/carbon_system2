...
@section('body')
    ...
    <div class="row">
        <div class="col-xl-12 mt-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('ghg_protocol.update',$data->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="iso14064_id" required >
                                            <option value="0" selected>請選擇...</option>
                                            @foreach($iso14064s as $iso14064)
                                                <option value="{{ $iso14064->id }}" @if($data->iso14064_id == $iso14064->id) selected @endif>{{ $iso14064->name }}</option>
                                            @endforeach
