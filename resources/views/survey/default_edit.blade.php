...
@section('body')
    ...
    @endsection
    @section('content')
    <form action="{{ route('survey.questions.default.update',$survey->id) }}" method="POST">
    @csrf
        <div class="row">
                                ...
                                <div class="col-md-12 mt-3" id="questionnaire">
                                    ...
                                    @foreach($datas as $data)
                                        <div class="hstack gap-3 mb-3">
                                            <div class="col-md-2">
                                                <input class="form-control me-3" type="text" placeholder="設定級距分數" name="scores[]" value="{{ $data->score }}">
                                            </div>
                                            <div class="col-md-4">
                                                <input class="form-control me-3" type="text" placeholder="設定級距回覆" name="replys[]" value="{{ $data->reply }}">
                                            </div>
                                            <div class="col-md-5">
                                                <input class="form-control me-3" type="text" placeholder="設定級距給予建議" name="suggestions[]" value="{{ $data->suggestion }}">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
