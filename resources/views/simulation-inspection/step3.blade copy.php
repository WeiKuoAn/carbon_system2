                ...
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" id="basic_inventory_id" name="basic_inventory_id" value="{{ $inventory->id }}">
                                    <div class="mb-3">
                ...
                $('#btn_create').on('click', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            content += '</li>';
                            content += '<li class="list-inline-item">';
                            content += '<a href="#" data-bs-toggle="modal" data-bs-target=".create-source" data-bs-placement="top" title="data" class="px-2 text-danger"><i class="mdi mdi-chart-bar font-size-20"></i></a>';
                            content += '</li>';
                            content += '</ul>';
                            content += '</td>';
                            content += '</tr>';
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        console.log('#emissionTable-' + old_scope_id + ' tr[data-row-id="' + editId + '"]');
                                            ...
                                            content1 += '</li>';
                                            content1 += '<li class="list-inline-item">';
                                            content1 += '<a href="#" data-bs-toggle="modal" data-bs-target=".create-source" data-bs-placement="top" title="data" class="px-2 text-danger"><i class="mdi mdi-chart-bar font-size-20"></i></a>';
                                            content1 += '</li>';
                                            content1 += '</ul>';
                                            content1 += '</td>';
                                            content1 += '</tr>';
